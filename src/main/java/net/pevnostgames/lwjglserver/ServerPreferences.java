...
public class ServerPreferences implements Preferences {
	private final String name;
	private final Properties properties = new Properties();
	private final FileHandle file;

	public ServerPreferences(String name) {
		this(new ServerFileHandle(new File(".prefs/" + name), Files.FileType.External));
	}

	public ServerPreferences(FileHandle file) {
		this.name = file.name();
		this.file = file;
